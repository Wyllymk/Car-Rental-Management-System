...
<html lang="en">
    <head>
        ...
        <title>Landing Page - Twilight Car Rentals</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="#!">Twilight Car Rentals</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Login to start browsing the car listing!</h1> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        ...
                        <p class="text-muted small mb-4 mb-lg-0">&copy; Twilight 2022. All Rights Reserved.</p>
                    </div>
